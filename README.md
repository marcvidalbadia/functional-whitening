...
In section 4 the sentence "As `math 2tr(\varGamma_{X\mathbb{X}}) is the only dependence between the original and the whitened variable, the minimization problem can be reduced to the maximization of tr$(\varGamma_{X\mathbb{X}})$." reads also as "... is the only dependent term...".
